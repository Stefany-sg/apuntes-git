...
4. [Clase 3](#clase-3)
    - [Fusionar ramas](#fusionar-ramas)
        - [Fast forward](#qué-es-un-fast-forward)
    - [Eliminar ramas](#eliminar-ramas-por-qué)
...
5. [Clase 4](#clase-4)
    ...
    - [Enlazar repositorios](#enlazar-repositorio-local-con-el-repositorio-remoto)
    - [Generar SSH key](#generar-key-ssh)
    - [Actualizar repositorio local](#actualizar-repositorio-local)
    - [git push, git pull y pull request](#git-push-git-pull-y-pull-request)
        - [git push](#git-push)
            - [Comandos](#comandos-de-git-push)
        - [git pull](#git-pull)
            - [Comandos](#comandos-de-git-pull)
        - [Pull request](#qué-es-un-pull-request)
            - [Crear PR](#cómo-se-hace)
            - [Tips](#tips)
6. [Clase 5](#clase-5)
  - [Qué es un git flow?](#qué-es-un-gitflowgit)
	- [Git Flow](#git-flow)
	- [Github Flow](#github-flow)
	- [Trubk Based Development](#trunk-based-development)
	- [Ship/Show/Ask](#shipshowask)
7. [Clase 6](#clase-6)
    - [Función](#función)
    - [Buenas prácticas](#buenas-practicas-en-git)
	- [Escribir buenos commits](#escribir-buenos-commits)
		- [Prefijos](#prefijos)
	- [Escribir un buen nombre de rama](#escribir-un-buen-nombre-de-rama-sugerencias)
8. [Clase 7](#clase-7)
    - [Deshacer cambios](#deshacer-cambios)
	- [Comandos Destructivos y no destructivos](#comandos-destructivos-y-no-destructivos)
	- [git reset](#git-reset)
		- [hard](#hard)
		- [Soft](#soft)
...
9. [Clase 8](#clase-8)
    - [Hooks, Alias y trucos](#hooks-alias-y-trucos-de-git)
	- [Hooks](#hook)
	- [Alias](#alias)
	- [Trucos](#trucos-en-git)
